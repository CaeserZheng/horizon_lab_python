...
from horizon_lab_python.horizon.auth import Auth
from horizon_lab_python.horizon.services.deviceManager.space import deviceSpaceManager
from horizon_lab_python.horizon.services.deviceManager.device import deviceManager
import urllib
...
if __name__ == '__main__':
    ...
    current = 1
    per_page = 1
    #print(dm.list(current,per_page))
